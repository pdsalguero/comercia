...
export const CATEGORY_CONFIGS: CategoryConfig[] = [
  ...
  // ── 11. CELULARES ─────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        options: [
          { value: "excelente", label: "Excelente (más de 90%)" },
          { value: "bueno", label: "Bueno (80–90%)" },
          { value: "regular", label: "Regular (70–80%)" },
          { value: "bajo", label: "Bajo (menos de 70%)" },
          { value: "nueva", label: "Batería nueva" },
  ...
  // ── 13. BEBÉS Y NIÑOS ─────────────────────────────────────────
  {
    ...
    subcats: [
      ...
      { value: "ropa-nino", label: "Ropa de niño/a" },
      { value: "coche", label: "Coche / Silla de auto" },
      { value: "cuna", label: "Cuna / Moisés / Corralito" },
      { value: "juguete", label: "Juguete" },
      { value: "lactancia", label: "Lactancia / Alimentación" },
      { value: "educativo", label: "Material educativo" },
      { value: "otro", label: "Otro" },
    ],
    fields: [
      {
