...
const ACTIONS: {
  ...
  { Icon: Car,       bg: "#eff6ff", fg: "#2563eb", title: "Ver autos",            sub: "Usados y nuevos",           href: "/category/vehicles?sub_category=auto" },
  { Icon: CarFront,  bg: "#ecfdf5", fg: "#059669", title: "Pickups y SUV",        sub: "Utilitarios y 4x4",         href: "/category/vehicles?sub_category=camioneta" },
  { Icon: Motorbike, bg: "#fff1f2", fg: "#e11d48", title: "Ver motos",            sub: "Calle, enduro y más",       href: "/category/vehicles?sub_category=moto" },
  { Icon: Store,     bg: "#f5f3ff", fg: "#7c3aed", title: "Concesionarias",       sub: "Tiendas verificadas",       href: "/tiendas" },
