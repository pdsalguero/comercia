...
export default async function TiendaPage({
  ...
  let query = supabase
    .from("listings")
    .select(`id, title, price, currency, condition, city, neighborhood, created_at, attributes, featured_level, view_count, category_id, categories(id, name, slug), listing_images(url, position)`)
    .eq("status", "active")
